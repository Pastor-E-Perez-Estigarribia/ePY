...
case_by_age_and_sex = read.csv("data/processed_data/case_df_by_age_and_sex_oldbins.csv")
...
save(df_plot, file="output/vaccine_estimates_ve98.Rdata")
...
pcust = gridExtra::grid.arrange(grobs=list(p11, p12,p13, p32,p33),
                                layout_matrix=rbind(c(1,2,3),
                                                    c(1,4,5)),
...
ggsave(pcust,filename = "output/fig/figure_s1_95ve.pdf", width=11*0.9*1.3, height=5.05*1.3)
ggsave(pcust,filename = "output/fig/figure_s1_95ve.png", width=11*0.9*1.3, height=5.05*1.3)
...
df_out %>% reframe(coverage = coverage,
                   ...
                   infections_averted = (infections_control-infections)/infections_control*100,
                   cases_averted = (cases_control-cases)/cases_control*100,
                   deaths_averted = (deaths_control-deaths)/deaths_control*100)
